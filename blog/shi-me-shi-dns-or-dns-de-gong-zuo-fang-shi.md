---
title: '什么是 DNS？ | DNS 的工作方式'
date: 2022-04-28 22:13:23
tags: [Network]
...
![](https://umeimmense.github.io/post-images/1651069131124.webp)
...
![](https://umeimmense.github.io/post-images/1651069180375.webp)
值得一提的是，在查询对象为子域（例如 foo.example.com 或 blog.example.com）的情况下，将向权威性域名服务器之后的序列添加一个附加域名服务器，其负责存储该子域的 CNAME 记录。
![](https://umeimmense.github.io/post-images/1651069212505.webp)
...
![](https://umeimmense.github.io/post-images/1651069273938.webp)
...
![](https://umeimmense.github.io/post-images/1651069314691.webp)
...
> [原文地址](https://www.cloudflare.com/zh-cn/learning/dns/what-is-dns/)
